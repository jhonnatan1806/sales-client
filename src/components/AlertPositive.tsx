...
export default function AlertPositive({ close }: {close: () => void }) {
	return (
		<div
			role="alert"
			className="flex items-start md:items-center max-w-full shadow-md bg-positive-100 pr-2 p-4 ring-1 ring-positive-200 typography-text-sm md:typography-text-base py-1 rounded-md select-none">
